...
var SupportedHosts = map[string]*Host{
	...
	"x86_64-w64-mingw32": {
		...
		Env: []string{
			...
			"*:*:CC=x86_64-w64-mingw32-gcc --sysroot=$PREFIX/sysroot -I$PREFIX/include -I$PREFIX/usr/include",
			"*:*:CXX=x86_64-w64-mingw32-g++ --sysroot=$PREFIX/sysroot -I$PREFIX/include -I$PREFIX/include/c++/15.2.0 -I$PREFIX/include/c++/15.2.0/x86_64-w64-mingw32 -I$PREFIX/usr/include",
			"*:*:CXXFLAGS=$CFLAGS",
