...
var SupportedHosts = map[string]*Host{
	...
	// 	Env: []string{
	// 		"all:HOST=x86_64-w64-mingw32",
	// 		"all:TARGET=x86_64-w64-mingw32",
	// 		"all:CC_target=x86_64-w64-mingw32",
	// 		"all:CC=x86_64-w64-mingw32-gcc",
	// 		"all:CXX=x86_64-w64-mingw32-g++",
	// 		"all:CXXFLAGS=$CFLAGS",
	// 		"all:RANLIB=x86_64-w64-mingw32-ranlib",
	// 		"all:AR=x86_64-w64-mingw32-ar",
	// 		"all:AS=x86_64-w64-mingw32-as",
	// 		"all:LIBTOOL=x86_64-w64-mingw32-libtool",
	// 		"all:OBJCOPY=x86_64-w64-mingw32-objcopy",
	// 		"all:OBJDUMP=x86_64-w64-mingw32-objdump",
	// 		"all:STRIP=x86_64-w64-mingw32-strip",
	// 		"all:READELF=x86_64-w64-mingw32-readelf",
	// 		"all:LD=x86_64-w64-mingw32-ld",
	// 		"all:NM=x86_64-w64-mingw32-nm",
	// 	},
	// },
	"x86_64-linux-gnu": {
		...
		Env: []string{
			...
			"all:CC=x86_64-unknown-linux-gnu-gcc",
			"all:CXX=x86_64-unknown-linux-gnu-g++",
			"all:CXXFLAGS=$CFLAGS",
			"all:RANLIB=x86_64-unknown-linux-gnu-ranlib",
			"all:AR=x86_64-unknown-linux-gnu-ar",
			"all:AS=x86_64-unknown-linux-gnu-as",
			"all:LIBTOOL=x86_64-unknown-linux-gnu-libtool",
			"all:OBJCOPY=x86_64-unknown-linux-gnu-objcopy",
			"all:OBJDUMP=x86_64-unknown-linux-gnu-objdump",
			"all:STRIP=x86_64-unknown-linux-gnu-strip",
			"all:READELF=x86_64-unknown-linux-gnu-readelf",
			"all:LD=x86_64-unknown-linux-gnu-ld",
			"all:NM=x86_64-unknown-linux-gnu-nm",
		},
	},
	"aarch64-linux-gnu": {
		...
		Env: []string{
			...
			"all:CC=aarch64-unknown-linux-gnu-gcc",
			"all:CXX=aarch64-unknown-linux-gnu-g++",
			"all:CXXFLAGS=$CFLAGS",
			"all:RANLIB=aarch64-unknown-linux-gnu-ranlib",
			"all:AR=aarch64-unknown-linux-gnu-ar",
			"all:AS=aarch64-unknown-linux-gnu-as",
			"all:LIBTOOL=aarch64-unknown-linux-gnu-libtool",
			"all:OBJCOPY=aarch64-unknown-linux-gnu-objcopy",
			"all:OBJDUMP=aarch64-unknown-linux-gnu-objdump",
			"all:STRIP=aarch64-unknown-linux-gnu-strip",
			"all:READELF=aarch64-unknown-linux-gnu-readelf",
			"all:LD=aarch64-unknown-linux-gnu-ld",
			"all:NM=aarch64-unknown-linux-gnu-nm",
		},
	},
	"aarch64-linux-android": {
		...
		Env: []string{
			...
			"all:LDFLAGS=$PREFIX/usr/lib/libc++_static.a $PREFIX/usr/lib/libc++abi.a -lm -lc -llog",
		},
	},
