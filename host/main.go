...
var SupportedHosts = map[string]*Host{
	"aarch64-apple-darwin": {
		...
		Env: []string{
			...
			"*:CC=aarch64-apple-darwin25-clang -mmacosx-version-min=$OSX_MIN_VERSION --sysroot $PREFIX/native/SDK/MacOSX26.0.sdk -I$PREFIX/native/SDK/MacOSX26.0.sdk/usr/include -I$PREFIX/include",
			"*:CXX=aarch64-apple-darwin25-clang++ -mmacosx-version-min=$OSX_MIN_VERSION --sysroot $PREFIX/native/SDK/MacOSX26.0.sdk -I$PREFIX/native/SDK/MacOSX26.0.sdk/usr/include -I$PREFIX/include",
			"*:CFLAGS=",
