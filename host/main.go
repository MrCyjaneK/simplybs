...
var SupportedHosts = map[string]*Host{
	...
	"x86_64-w64-mingw32": {
		...
		Env: []string{
			...
			"*:*:RC=x86_64-w64-mingw32-windres -I$PREFIX/sysroot/usr/x86_64-w64-mingw32/include -I$PREFIX/include -I$PREFIX/usr/include",
			"*:*:CC=x86_64-w64-mingw32-gcc --sysroot=$PREFIX/sysroot -I$PREFIX/sysroot/usr/x86_64-w64-mingw32/include -I$PREFIX/include -I$PREFIX/usr/include",
			"*:*:CXX=x86_64-w64-mingw32-g++ --sysroot=$PREFIX/sysroot -I$PREFIX/sysroot/usr/x86_64-w64-mingw32/include -I$PREFIX/include -I$PREFIX/include/c++/15.2.0 -I$PREFIX/include/c++/15.2.0/x86_64-w64-mingw32 -I$PREFIX/usr/include",
			"*:*:CXXFLAGS=$CFLAGS",
	...
	"x86_64-linux-gnu": {
		...
		Env: []string{
			...
			"*:*:CC=x86_64-linux-gnu-gcc --sysroot=$PREFIX/sysroot -I$PREFIX/include -I$PREFIX/usr/include",
			"*:*:CXX=x86_64-linux-gnu-g++ --sysroot=$PREFIX/sysroot -I$PREFIX/include -I$PREFIX/include/c++/15.2.0 -I$PREFIX/include/c++/15.2.0/x86_64-linux-gnu -I$PREFIX/usr/include",
			"*:*:CXXFLAGS=$CFLAGS",
	...
	"aarch64-linux-gnu": {
		...
		Env: []string{
			...
			"*:*:CC=aarch64-linux-gnu-gcc --sysroot=$PREFIX/sysroot -I$PREFIX/include -I$PREFIX/usr/include",
			"*:*:CXX=aarch64-linux-gnu-g++ --sysroot=$PREFIX/sysroot -I$PREFIX/include -I$PREFIX/include/c++/15.2.0 -I$PREFIX/include/c++/15.2.0/aarch64-linux-gnu -I$PREFIX/usr/include",
			"*:*:CXXFLAGS=$CFLAGS",
