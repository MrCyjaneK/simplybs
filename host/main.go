...
var SupportedHosts = map[string]*Host{
	"aarch64-apple-darwin": {
		...
		Env: []string{
			...
			"*:*:CC=aarch64-apple-darwin25-clang -mmacosx-version-min=$OSX_MIN_VERSION -isysroot $PREFIX/native/SDK/MacOSX26.0.sdk -I$PREFIX/native/SDK/MacOSX26.0.sdk/usr/include -I$PREFIX/include",
			"*:*:CXX=aarch64-apple-darwin25-clang++ -mmacosx-version-min=$OSX_MIN_VERSION -isysroot $PREFIX/native/SDK/MacOSX26.0.sdk -I$PREFIX/native/SDK/MacOSX26.0.sdk/usr/include -I$PREFIX/include",
			"*:*:CFLAGS=",
			"*:*:CXXFLAGS=$CFLAGS -stdlib=libc++",
			"*:*:RANLIB=llvm-ranlib",
			"*:*:AR=llvm-ar",
			"*:*:LIBTOOL=llvm-libtool-darwin",
			"*:*:SDK_PATH=$PREFIX/native/SDK/MacOSX26.0.sdk",
			"*:*:LDFLAGS=-lc++ -lc++abi",
		},
	},
	"x86_64-apple-darwin": {
		...
		Env: []string{
			...
			"*:*:CC=x86_64-apple-darwin25-clang -mmacosx-version-min=$OSX_MIN_VERSION -isysroot $PREFIX/native/SDK/MacOSX26.0.sdk -I$PREFIX/native/SDK/MacOSX26.0.sdk/usr/include -I$PREFIX/include",
			"*:*:CXX=x86_64-apple-darwin25-clang++ -mmacosx-version-min=$OSX_MIN_VERSION -isysroot $PREFIX/native/SDK/MacOSX26.0.sdk -I$PREFIX/native/SDK/MacOSX26.0.sdk/usr/include -I$PREFIX/include",
			"*:*:CFLAGS=",
			"*:*:CXXFLAGS=$CFLAGS -stdlib=libc++",
			"*:*:RANLIB=llvm-ranlib",
			"*:*:AR=llvm-ar",
