...
$(package)_build_dependencies=native_ccache native_python3 native_rust_1_69_0 native_cargo_0_68_0
...
define $(package)_stage_cmds
    mkdir -p $($(package)_staging_prefix_dir)/rust_1_70_0/bin && \
    cp -a build/*/stage1/lib $($(package)_staging_prefix_dir)/rust_1_70_0 && \
    cp -a build/*/stage1/bin/rustc $($(package)_staging_prefix_dir)/rust_1_70_0/bin
endef
