...
$(package)_build_dependencies=native_ccache native_python3 native_rust_1_66_1 native_cargo_0_64_0
...
define $(package)_stage_cmds
    mkdir -p $($(package)_staging_prefix_dir)/rust_1_67_1/bin && \
    cp -a build/*/stage1/lib $($(package)_staging_prefix_dir)/rust_1_67_1 && \
    cp -a build/*/stage1/bin/rustc $($(package)_staging_prefix_dir)/rust_1_67_1/bin
endef