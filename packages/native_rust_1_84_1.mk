package=native_rust_1_84_1
$(package)_version=1.84.1
...
$(package)_build_dependencies=native_ccache native_python3 native_rust_1_83_0
...
define $(package)_preprocess_cmds
    ...
    echo 'rustc = "$(host_prefix)/native/rust_1_83_0/bin/rustc"' >> config.toml && \
...
define $(package)_stage_cmds
    mkdir -p $($(package)_staging_prefix_dir)/rust_1_84_1/bin && \
    cp -a build/*/stage1/lib $($(package)_staging_prefix_dir)/rust_1_84_1 && \
    cp -a build/*/stage1/bin/rustc $($(package)_staging_prefix_dir)/rust_1_84_1/bin
endef
